...
public class EnemigoFinalControlador : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Restablece la escala inicial del enemigo para que mire hacia la derecha
        transform.localScale = new Vector3(1, 1, 1); // Escala inicial (mirando hacia la derecha)
        direccionPatrullaje = 1; // Inicia patrullando hacia la derecha
    }
